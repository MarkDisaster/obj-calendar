...
interface MockData {
   ...
   /**
    * The date and time associated with this time slot in format (e.g., '2024-01-01T14:00:00').
    * @type {string}
    */
   DateISO: string;
}
...
export interface Data {
   /**
    * The date associated with the collection of time slots, formatted in ISO 8601 format (e.g., '2024-01-01').
    * @type {string}
    */
   date: string;
